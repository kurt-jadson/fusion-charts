...
public class FusionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acessou(uri, "column2d")) {
            ...
            datasource = dataReader.getData("/WEB-INF/charts/mscolumn2d.js");
        } else if (acessou(uri, "mscombi2d")) {
            chart.setType(Type.MS_COMBI_2D);
            datasource = dataReader.getData("/WEB-INF/charts/mscombi2d.js");
        } else if (acessou(uri, "column3d")) {
            chart.setType(Type.COLUMN_3D);
            datasource = dataReader.getData("/WEB-INF/charts/column2d.js");
        } else if (acessou(uri, "pie2d")) {
            chart.setType(Type.PIE_2D);
            datasource = dataReader.getData("/WEB-INF/charts/pie2d.js");
        }
